// Shared "platform components" + "beyond optimization" card bodies.
// Used by the homepage product section AND the /pitch-short(-2) appendix
// slides so the SVG-heavy markup lives in exactly one place.

import { Sparkles, Eye } from "lucide-react";

// ---------- Optimization Engine ----------
export function OptimizationEngineBody() {
  return (
    <>
...
export function FeedbackLoopConnector() {
  return (
...
// ---------- Agent Wrapper ----------
export function AgentWrapperBody() {
  return (
    <>
      <div className="flex items-center gap-3 mb-3">
...
export function BenchmarkCardBody() {
  return (
    <>
      <div className="flex items-center gap-3 mb-3">
...
export function ObservabilityCardBody() {
  return (
    <>
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400">
