...
function SlideMarketAndRevenue() {
  ...
  return (
    <div className="w-full max-w-[1180px] mx-auto text-center self-stretch flex flex-col min-h-[600px]">
      ...
      {/* Assumptions strip — rendered at the bottom via order-last */}
      <div className="bg-slate-900/70 border border-slate-700/60 rounded-xl p-3 mt-3 text-left order-last">
        <div className="text-[10px] font-mono uppercase tracking-widest text-slate-400 mb-1.5">Assumptions</div>
    ...
    <div className="w-full">
      <div className="text-center mb-5">
        ...
        <p className="text-lg md:text-2xl font-semibold text-slate-200 mt-2 leading-snug">
          <span className="text-white">Traigent</span> harnesses <span className="text-blue-400">your coding agent</span> <span className="text-slate-400 font-normal">(Claude Code, Cursor, Codex, etc.)</span> to get it done
        </p>
        <p className="text-lg md:text-2xl font-semibold text-slate-200 mt-1.5 leading-snug">
          Traigent evolves <span className="text-blue-400">optimized agents</span> across <span className="text-white">4 pillars</span>
        </p>
      </div>
  ...
  return (
    <div className="w-full max-w-[1180px] mx-auto text-center self-stretch flex flex-col min-h-[600px]">
      <div className="mb-3">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">
          Land, expand, own the <span className="text-[#4D8EF8]">Agent Optimization</span> category
        </h2>
      </div>
