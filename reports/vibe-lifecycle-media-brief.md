...
- Do not present `/agent.md`, skill bundles, or coding-agent plugins as requirements or CTAs on
  this campaign page; the general Get Started surface may still offer them as optional developer
  workflows.
